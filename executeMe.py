...
modelLABEL, modelL3, modelMUSCLE                 = ODIASP.load_modelsODIASP(PATH_MODELS_ODIASP, strategy=strategy, muscle = SEGM_MUSCLES)
...
#Chargement des différents réseaux
_, _, modelMUSCLE                 = ODIASP.load_modelsODIASP(PATH_MODELS_ODIASP, strategy=strategy, label = False, L3 = False)
...
"""
ODIASP.FusionResultats(DossierDuProjet,
